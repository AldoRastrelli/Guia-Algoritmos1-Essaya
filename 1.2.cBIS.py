...
print("Calcularemos el área de un rectángulo a partir de las coordenadas de sus vértices opuestos (x1,y1) y (x2,y2)")
...
print ("El área es",programa(x1,x2,y1,y2))
