...
def verifica_suma_de_div_igual_numero(i,j):
    """verifica que i sea igual a la suma de los divisores de j
    y que al mismo tiempo j sea igual a la suma de los divisores de i"""

    if i < j: #Para que no se me repitan las parejas como por ejemplo (1,2) (2,1)
        return i<j and  i == suma_de_divisores(j) and j == suma_de_divisores(i)
...
#El programa tarda en ejecutar 2.819277763366699 segundos con el número 300 (import time, start, end)